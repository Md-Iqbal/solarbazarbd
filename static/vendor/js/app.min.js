!(function (l) {
        ...
        i('.navbar-nav a').each(function () {
          ...
          if (this.href == t) {
            i(this).addClass('active'),
              ...
              i(this).parent().parent().parent().parent().addClass('active');
            var e = i(this)
              .parent()
              .parent()
              .parent()
  ...
  (function (i) {
    ...
    (t.prototype.selectOptionsFromConfig = function () {
      ...
      t &&
        (i(
          'input[type=radio][name=color-scheme-mode][value=' + t.mode + ']'
        ).prop('checked', !0),
        ...
        i(
          'input[type=radio][name=menus-position][value=' + t.menuPosition + ']'
        ).prop('checked', !0),
        i(
        ...
        i(
          'input[type=radio][name=topbar-color][value=' + t.topbar.color + ']'
        ).prop('checked', !0));
    }),
    ...
    (t.prototype.initControls = function () {
      function t() {
        document.webkitIsFullScreen ||
          ...
          (console.log('pressed'), e('body').removeClass('fullscreen-enable'));
      }
      setTimeout(function () {
