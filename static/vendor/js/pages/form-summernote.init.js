!function (n) {
    ...
    e.prototype.init = function () {
        n("#summernote-basic").summernote({
            placeholder: "Write something...", height: 230, callbacks: {
                onInit: function (e) {
        ...
        n("#summernote-edit").on("click", function () {
            ...
            hint: {
                words: ["apple", "orange", "watermelon", "lemon"], match: /\b(\w{1,})$/, search: function (t, e) {
                    e(n.grep(this.words, function (e) {
                        return 0 === e.indexOf(t)
                    }))
                }
            }
        }), n.ajax({url: "https://api.github.com/emojis", async: !1}).then(function (e) {
            window.emojis = Object.keys(e), window.emojiUrls = e
        }), n("#summernote-emoji").summernote({
            height: 180, toolbar: !1, placeholder: "type starting with : and any alphabet", hint: {
                match: /:([\-+\w]+)$/, search: function (t, e) {
            ...
            height: 100, toolbar: !1, hint: {
                mentions: ["jayden", "sam", "alvin", "david"], match: /\B@(\w*)$/, search: function (t, e) {
